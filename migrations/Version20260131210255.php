 ...
 */
final class Version20260131210255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis DROP prestation_autre');
        ...
        $this->addSql('ALTER TABLE demande_prestation CHANGE details_specifiques details_specifiques VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis ADD prestation_autre LONGTEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE demande_prestation CHANGE details_specifiques details_specifiques VARCHAR(255) NOT NULL');
