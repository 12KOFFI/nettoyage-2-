 ...
 */
final class Version20260309234511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE local ADD adresse VARCHAR(255) NOT NULL, ADD code_postal VARCHAR(10) NOT NULL');
        $this->addSql('ALTER TABLE prestation ADD types_local JSON DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE local DROP adresse, DROP code_postal');
        $this->addSql('ALTER TABLE prestation DROP types_local');
