 ...
 */
class getAccessDeniedListenerService extends App_KernelProdContainer
{
    /*
    ...
    {
        $instance = new \App\EventListener\AccessDeniedListener(($container->services['router'] ?? self::getRouterService($container)), new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        if (isset($container->privates['App\\EventListener\\AccessDeniedListener'])) {
            return $container->privates['App\\EventListener\\AccessDeniedListener'];
        }

        return $container->privates['App\\EventListener\\AccessDeniedListener'] = $instance;
    }
}
