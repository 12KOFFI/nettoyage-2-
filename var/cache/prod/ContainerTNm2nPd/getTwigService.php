...
class getTwigService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtension(new \App\Twig\DemandeDevisExtension(($container->privates['App\\Repository\\DemandeDevisRepository'] ?? $container->load('getDemandeDevisRepositoryService'))));
